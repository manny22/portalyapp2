...
export function SettingsPage() {
  return (
    <AppLayout>
      <PageLayout title="Configuración" description="Ajustes del conjunto residencial">
        <EmptyState
          title="Configuración en construcción"
          description="Próximamente podrás configurar torres, unidades y parámetros del conjunto."
          icon={
